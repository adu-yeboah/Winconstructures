        ...
        <div className="flex-1 flex flex-col bg-gray-50 relative">
          ...
          <div className="bg-white border-b border-gray-100 px-6 py-3.5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button className="relative w-9 h-9 rounded-lg border border-gray-200 bg-white flex items-center justify-center hover:bg-gray-50 transition-colors">
                <svg
                ...
                <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-secondary border-2 border-white" />
              </button>
