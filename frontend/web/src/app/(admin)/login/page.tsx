...
export default function LoginPage() {
  ...
  const fieldClass =
    "w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[13px] text-gray-900 outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all  bg-white";
  const labelClass =
    "block text-[10px] font-medium uppercase tracking-[0.07em] text-gray-500 mb-1.5";

  return (
    <div className="min-h-screen flex">
      {/* Left panel */}
      <div className="hidden lg:flex flex-col  flex-1 bg-primary p-10 relative overflow-hidden">
        <div
        ...
        <div className="relative  justify-center flex flex-col h-full">
          ...
          <p className="text-[13px] text-white/60 leading-relaxed max-w-sm">
            Manage your entire property portfolio — listings, clients, and
            revenue — all from one elegant dashboard.
          </p>
        </div>
      ...
      <div className="w-full lg:w-[580px] bg-white flex flex-col justify-center px-8 lg:px-10 py-12">
        ...
        <h2 className="font-serif text-[26px] font-semibold text-gray-900 mb-1">
          Welcome back
        </h2>
        <p className="text-[13px] text-tertiary mb-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button
              type="button"
              className="text-[13px] text-primary border-none!   font-medium hover:underline"
            >
              Forgot password?
            </button>
          </div>
